              ...
              >
                {[...featureContent, ...featureContent].map((item, idx) => (
                  <div
                    key={`top-${item.id}-${idx}`}
                    className="shrink-0"
                    style={{ width: idx % 2 === 0 ? "40cqw" : "60cqw" }}
                  >
            ...
            {additionalFeatures.map((feature) => {
              ...
              return (
                ...
                >
                  <CardContent className="p-4 text-center m-0">
                    <div
                      className={`w-12 h-12 text-primary flex items-center justify-center mx-auto mb-3 transition-colors duration-300`}
                    >
